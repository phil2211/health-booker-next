...
export default function WeeklyAvailabilityEditor({
  ...
  const DAYS_OF_WEEK = [
    ...
    { value: 3, label: t('availabilityEditor.days.wednesday') },
    { value: 4, label: t('availabilityEditor.days.thursday') },
    { value: 5, label: t('availabilityEditor.days.friday') },
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('availability.weeklyAvailability')}</h3>
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              {isEnabled && (
                ...
                >
                  + {t('availabilityEditor.addTimeRange')}
                </button>
              )}
            </div>
                  ...
                  >
                    ...
                    {dayEntries.length > 1 && (
                      <button
                        ...
                        aria-label={t('availabilityEditor.remove')}
                      >
                        <svg
                          className="w-5 h-5"
                          fill="none"
