        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-1 space-y-6 overflow-y-auto max-h-[800px] pr-2">
                    {therapists.length === 0 ? (
                        ...
                        therapists.map((therapist) => (
                            <div key={therapist._id} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border border-gray-100">
                ...
                <div className="lg:col-span-2 h-[600px] sticky top-4">
                    <ProviderMap therapists={therapists} />
                </div>
            </div>
        </div>
    )
